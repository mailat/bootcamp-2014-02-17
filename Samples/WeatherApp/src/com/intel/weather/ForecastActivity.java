...
public class ForecastActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Novosibirsk", "second activity onCreate");
    ...
    private class WeatherReaderUpdater extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                Log.d("Novosibirsk", "response back: " + response);
            } catch (Throwable e) {
                e.printStackTrace();
                Log.d("Novosibirsk", "doInBackground exception:" + e.getMessage());
            }
        ...
        protected void onPostExecute(Void result) {
        	Log.d("Novosibirsk", "onPosetExecute");
			try {
				JSONObject jobject = new JSONObject(response);
				int forecastCount = jobject.getInt("cnt");
				Log.d("Novosibirsk","Forecast count is " + String.valueOf(forecastCount));
				...
				Log.d("Novosibirsk", "onPostExecute exception: " + e.getMessage());
			}
        }
    }   
}
